...
type Component struct {
	...
	ClearIcon           interface{}            `json:"clearIcon,omitempty"`           // 自定义的清除图标
	ClearText           string                 `json:"clearText,omitempty"`           // 清除按钮的提示文案
	DefaultValue        interface{}            `json:"defaultValue,omitempty"`        // 默认的选中项
	Disabled            interface{}            `json:"disabled,omitempty"`            // 禁用
	DisabledTime        interface{}            `json:"disabledTime,omitempty"`        // 不可选择的时间
	Format              string                 `json:"format,omitempty"`              // 设置日期格式，为数组时支持多格式匹配，展示以第一个为准。
	HideDisabledOptions bool                   `json:"hideDisabledOptions,omitempty"` // 隐藏禁止选择的选项
	HourStep            int                    `json:"hourStep,omitempty"`            // 小时选项间隔
	...
	SecondStep          int                    `json:"secondStep,omitempty"`          // 秒选项间隔
	ShowNow             bool                   `json:"showNow,omitempty"`             // 面板是否显示“此刻”按钮
	...
	Use12Hours          bool                   `json:"use12Hours,omitempty"`          // 使用 12 小时制，为 true 时 format 默认为 h:mm:ss a
...
// 清除按钮的提示文案
func (p *Component) SetClearText(clearText string) *Component {
...
// 不可选择的时间
func (p *Component) SetDisabledTime(disabledTime interface{}) *Component {
	p.DisabledTime = disabledTime

	return p
}

// 隐藏禁止选择的选项
func (p *Component) SetHideDisabledOptions(hideDisabledOptions bool) *Component {
	p.HideDisabledOptions = hideDisabledOptions

	return p
}

// 小时选项间隔
func (p *Component) SetHourStep(hourStep int) *Component {
	p.HourStep = hourStep
...
// 分钟选项间隔
func (p *Component) SetMinuteStep(minuteStep int) *Component {
	p.MinuteStep = minuteStep

	return p
}

// 秒选项间隔
func (p *Component) SetSecondStep(secondStep int) *Component {
	p.SecondStep = secondStep

	return p
}

// 使用 12 小时制，为 true 时 format 默认为 h:mm:ss a
func (p *Component) SetUse12Hours(use12Hours bool) *Component {
	p.Use12Hours = use12Hours
