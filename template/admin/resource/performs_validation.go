...
// 创建请求的验证器
func (p *Template) ValidatorForCreation(ctx *quark.Context, data map[string]interface{}) error {
...
// 创建请求的验证规则
func (p *Template) RulesForCreation(ctx *quark.Context) (rules []rule.Rule) {
	fields := ctx.Template.(interface {
		CreationFieldsWithoutWhen(*quark.Context) interface{}
...
// 判断是否需要验证When组件里的规则
func (p *Template) needValidateWhenRules(ctx *quark.Context, when *when.Item) bool {
...
// 更新请求的验证器
func (p *Template) ValidatorForUpdate(ctx *quark.Context, data map[string]interface{}) error {
...
// 更新请求的验证规则
func (p *Template) RulesForUpdate(ctx *quark.Context) (rules []rule.Rule) {
	fields := ctx.Template.(interface {
		UpdateFieldsWithoutWhen(*quark.Context) interface{}
...
// 导入请求的验证器
func (p *Template) ValidatorForImport(ctx *quark.Context, data map[string]interface{}) error {
...
// 创建请求的验证规则
func (p *Template) RulesForImport(ctx *quark.Context) (rules []rule.Rule) {

	fields := ctx.Template.(interface {
		ImportFieldsWithoutWhen(*quark.Context) interface{}
...
// 验证完成后回调
func (p *Template) AfterValidation(ctx *quark.Context, validator interface{}) {
	//
}

// 创建请求验证完成后回调
func (p *Template) AfterCreationValidation(ctx *quark.Context, validator interface{}) {
	//
}

// 更新请求验证完成后回调
func (p *Template) AfterUpdateValidation(ctx *quark.Context, validator interface{}) {
	//
}

// 创建请求验证完成后回调
func (p *Template) AfterImportValidation(ctx *quark.Context, validator interface{}) {
	//
}
