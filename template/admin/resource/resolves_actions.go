...
import (
	...
	"github.com/quarkcloudio/quark-go/v3/template/admin/component/drawer"
	"github.com/quarkcloudio/quark-go/v3/template/admin/component/dropdown"
	"github.com/quarkcloudio/quark-go/v3/template/admin/component/form"
	"github.com/quarkcloudio/quark-go/v3/template/admin/component/modal"
...
// 列表行为
func (p *Template) IndexTableActions(ctx *quark.Context) interface{} {
	var items []interface{}
...
// 表格行内行为
func (p *Template) IndexTableRowActions(ctx *quark.Context) interface{} {
	var items []interface{}
...
// 表单页右上角自定义区域行为
func (p *Template) FormExtraActions(ctx *quark.Context) interface{} {
	var items []interface{}
...
// 详情页行为
func (p *Template) DetailActions(ctx *quark.Context) []interface{} {
	var items []interface{}
...
// 详情页右上角自定义区域行为
func (p *Template) DetailExtraActions(ctx *quark.Context) interface{} {
	var items []interface{}
...
// 创建行为组件
func (p *Template) BuildAction(ctx *quark.Context, item interface{}) interface{} {
...
// 创建行为接口
func (p *Template) BuildActionApi(ctx *quark.Context, params []string, uriKey string) string {
	var (
		paramsUri = ""
		api       = ctx.Path()
	)
