...
import (
	...
	"github.com/quarkcloudio/quark-go/v3/utils/excel"
...
// 执行行为
func (p *ExportRequest) Handle(ctx *quark.Context) error {
...
// 列表查询
func (p *ExportRequest) QueryData(ctx *quark.Context) interface{} {
...
func (p *ExportRequest) columnFilters(ctx *quark.Context) map[string]interface{} {
...
func (p *ExportRequest) orderings(ctx *quark.Context) map[string]interface{} {
	var data map[string]interface{}
...
// 处理列表
func (p *ExportRequest) performsList(ctx *quark.Context, lists []map[string]interface{}) []interface{} {
