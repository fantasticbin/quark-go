...
import (
	...
	"github.com/quarkcloudio/quark-go/v3/template/admin/component/menu"
...
// 初始化
func (p *Dropdown) TemplateInit(ctx *quark.Context) interface{} {
...
// 菜单
func (p *Dropdown) GetMenu(ctx *quark.Context) interface{} {
	var items []interface{}
