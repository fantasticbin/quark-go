...
// 更新表单的接口
func (p *Template) UpdateApi(ctx *quark.Context) string {
...
// 编辑页面获取表单数据接口
func (p *Template) EditValueApi(request *quark.Context) string {
...
// 渲染编辑页组件
func (p *Template) UpdateComponentRender(ctx *quark.Context, data map[string]interface{}) interface{} {
...
// 编辑页面显示前回调
func (p *Template) BeforeEditing(request *quark.Context, data map[string]interface{}) map[string]interface{} {
	return data
}
