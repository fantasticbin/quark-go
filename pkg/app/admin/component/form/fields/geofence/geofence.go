...
func (p *Component) Init() *Component {
	...
	p.DefaultValue = map[string]interface{}{
...
// zoom
func (p *Component) SetZoom(zoom int) *Component {
	p.Zoom = zoom
	return p
}
...
// 中心点
func (p *Component) SetCenter(longitude string, latitude string) *Component {
...
// 多边形围栏坐标点
func (p *Component) SetPoints(points []interface{}) *Component {
