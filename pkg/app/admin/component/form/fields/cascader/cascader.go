...
func (p *Component) SetChangeOnSelect(changeOnSelect bool) *Component {
...
// 自定义次级菜单展开图标
func (p *Component) SetExpandIcon(expandIcon interface{}) *Component {
...
func (p *Component) SetExpandTrigger(expandTrigger string) *Component {
...
func (p *Component) SetShowCheckedStrategy(showCheckedStrategy string) *Component {
...
// 设置搜索的值，需要与 showSearch 配合使用
func (p *Component) SetDropdownMenuColumnStyle(dropdownMenuColumnStyle interface{}) *Component {
