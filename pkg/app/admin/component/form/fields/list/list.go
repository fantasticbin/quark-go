...
// 按钮名称
func (p *Component) SetButton(text string, position string) *Component {
	p.ButtonText = text
...
// 表单项
func (p *Component) SetItem(callback interface{}) *Component {
...
// Item 中总是展示 label
func (p *Component) SetAlwaysShowItemLabel(alwaysShowItemLabel bool) *Component {
