...
// 当前可选项
func (p *Component) GetOptions() interface{} {
	data := map[int]interface{}{
		0: p.UnCheckedChildren,
		1: p.CheckedChildren,
	}
...
// 初始是否选中
func (p *Component) SetDefaultChecked(defaultChecked bool) *Component {
...
// 选中时的内容
func (p *Component) SetTrueValue(value interface{}) *Component {
...
// 非选中时的内容
func (p *Component) SetFalseValue(value interface{}) *Component {
