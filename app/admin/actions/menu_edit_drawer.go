...
// 初始化
func (p *MenuEditDrawerAction) Init(ctx *quark.Context) interface{} {
...
// 内容
func (p *MenuEditDrawerAction) GetBody(ctx *quark.Context) interface{} {
...
// 弹窗行为
func (p *MenuEditDrawerAction) GetActions(ctx *quark.Context) []interface{} {
