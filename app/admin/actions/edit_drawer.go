...
// 初始化
func (p *EditDrawerAction) Init(ctx *quark.Context) interface{} {
...
// 内容
func (p *EditDrawerAction) GetBody(ctx *quark.Context) interface{} {
...
// 弹窗行为
func (p *EditDrawerAction) GetActions(ctx *quark.Context) []interface{} {
